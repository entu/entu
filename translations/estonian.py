...
def translation():
    return {
        ...
        'application_message_email2_message': 'Tere,<br /><br />Kirjutasid oma <a href="http://bonga.artun.ee/application">sisseastumisavalduse</a> juurde:<br /><br />%s<br /><br />Märge selle kohta jõudis ka vastuvõtutöötajatele. Vastusest anname teada emaili teel.',
        ...
        'application_message_email4_subject': '%s, Sinu sisseastumisavaldus vajab täiendamist',
        'application_message_email4_message': 'Tere,<br /><br />%(name)s lisas Su <a href="http://bonga.artun.ee/application">sisseastumisavaldusele</a> kommentaari:<br /><br />%(text)s<br /><br />Tee vajalikud muudatused ja esita avaldus uuesti. Seda saad teha aadressil <a href="http://bonga.artun.ee/application">bonga.artun.ee/application</a>.',
        ...
        'application_accept_email2_message': 'Tere,<br /><br />Sinu esitatud <a href="http://bonga.artun.ee/application">sisseastumisavaldus</a> on kinnitatud.<br /><br />Info eksamite ja katsete kohta saadame meilitsi.',
