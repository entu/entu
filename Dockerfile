...
RUN pip install beautifulsoup4 boto chardet markdown2 mistune mysql-python pillow python-dateutil PyYAML raven SimpleAES suds tornado torndb xmltodict
