...
RUN pip install beautifulsoup4 boto bugsnag chardet markdown2 mistune mysql-python newrelic pillow python-dateutil PyYAML SimpleAES suds tornado torndb xmltodict
