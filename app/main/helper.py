...
class myDatabase():
    ...
    def mongodb(self, database=None):
        ...
        try:
            ...
            self.settings['mongodbs'][database] = MongoClient(self.settings['mongodb'], ssl=True, ssl_ca_certs=APP_MONGODB_CA_FILE, serverSelectionTimeoutMS=2000, socketKeepAlive=True, connect=False)[database]
