...
class ShowOfflineManifest(myRequestHandler, Entity):
    def get(self, entity_id):
        schedule = get_schedule(entity_id=entity_id, days=7)



class ShowSchedule(myRequestHandler, Entity):
    def get(self, entity_id):
        schedule = get_schedule(entity_id=entity_id, days=7)
        self.write(schedule)


def get_schedule(entity_id, days=7):
        ...
        for lp in layout_playlists:
            ...
            for pm in playlist_medias:
                ...
                for t in run_times:
                    ...
                    # schedule
                    schedule_dict.setdefault(int(time.mktime(t.timetuple())), {})['time'] = str(t)
...
handlers = [
    ...
    (r'/screenwerk/screen-(.*)/manifest', ShowOfflineManifest),
]
