            ...
            for lp in layout_playlists:
                ...
                for pm in playlist_medias:
                    ...
                    for t in run_times:
                        ...
                        schedule_dict.setdefault(int(time.mktime(t.timetuple())), {}).setdefault('playlists', {}).setdefault(lp.get('id'), {}).setdefault('media', {}).setdefault(pm.get('id'), {})['strech'] = bool(pm.get('properties', {}).get('strech', {}).get('values', [{}])[0].get('db_value', False))
